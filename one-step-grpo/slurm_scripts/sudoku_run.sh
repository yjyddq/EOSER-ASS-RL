...
#SBATCH -N 1
#SBATCH -o /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/one-step-grpo/logs/one-step-grpo-sudoku-%j.out
#SBATCH -e /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/one-step-grpo/logs/one-step-grpo-sudoku-%j.err
