...
#SBATCH -N 1
#SBATCH -o /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/one-step-grpo/logs/one-step-grpo-math500-%j.out
#SBATCH -e /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/one-step-grpo/logs/one-step-grpo-math500-%j.err
...
accelerate launch \
    ...
    --main_process_port 12345 one_step_grpo_train.py \
