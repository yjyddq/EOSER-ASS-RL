...
@dataclass
class CJGRPOConfig(TrainingArguments):
    r"""
    ...
    block_num: Optional[int] = field(
        default=1,
        metadata={"help": "diffusion block num"},
    )
    adapter_path: Optional[str] = field(
        default="",
        metadata={
            "help": "Path to the adapter weights to merge with the base model. If None, no adapter is loaded."
        },
    )
    eos_min_gamma: Optional[float] = field(
        default=0.4,
        metadata={
            "help": "Attenuation coefficient for [EOS]/[EOT] confidence attenuate."
        },
    )
    eos_max_gamma: Optional[float] = field(
        default=1.0,
        metadata={
            "help": "Attenuation coefficient for [EOS]/[EOT] confidence attenuate."
        },
    ...
    decoding: Optional[str] = field(
        default='semi-AR',
        metadata={"help": "Decoding strategy"},
    )
