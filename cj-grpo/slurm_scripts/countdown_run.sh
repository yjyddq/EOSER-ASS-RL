...
#SBATCH -N 1
#SBATCH -o /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/cj-grpo/logs/cj-grpo-countdown-%j.out
#SBATCH -e /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/cj-grpo/logs/cj-grpo-countdown-%j.err
...
accelerate launch \
    ...
    --main_process_port 12353 cj_grpo_train.py \
