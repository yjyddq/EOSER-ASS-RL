...
#SBATCH -N 1
#SBATCH -o /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/cj-grpo/logs/cj-grpo-math500-%j.out
#SBATCH -e /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/cj-grpo/logs/cj-grpo-math500-%j.err
...
accelerate launch \
    ...
    --main_process_port 12345 cj_grpo_train.py \
