...
#SBATCH -N 1
#SBATCH -o /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/cj-grpo/logs/cj-grpo-gsm8k-%j.out
#SBATCH -e /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/cj-grpo/logs/cj-grpo-gsm8k-%j.err
...
accelerate launch \
    ...
    --main_process_port 12355 cj_grpo_train.py \
