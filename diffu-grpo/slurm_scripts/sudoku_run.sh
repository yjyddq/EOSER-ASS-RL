...
#SBATCH -N 1
#SBATCH -o /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/diffu-grpo/logs/diffu-grpo-sudoku-%j.out
#SBATCH -e /mnt/petrelfs/yangjingyi/EOSER-ASS-RL/diffu-grpo/logs/diffu-grpo-sudoku-%j.err
