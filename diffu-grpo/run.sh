...
cd /mnt/shared-storage-user/yangjingyi/EOSER-ASS-RL/diffu-grpo
...
LOGDIR=/mnt/shared-storage-user/yangjingyi/EOSER-ASS-RL/diffu-grpo/logs
SAVEDIR=/mnt/shared-storage-user/yangjingyi/EOSER-ASS-RL/diffu-grpo/checkpoints
mkdir -p $LOGDIR
mkdir -p $SAVEDIR
echo $LOGDIR
echo $SAVEDIR
...
DATASET="countdown"
RUN_NAME=diffu_grpo_${DATASET}_128_32_32
